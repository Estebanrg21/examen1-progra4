    ...
    <?php if ($_SESSION['isAdmin'] || $_SESSION['isSuper']) : ?>
      ...
      <li class="nav-item">
        <a class="nav-link  <?php echo (isset($option) ? (($option == 4) ? "active" : "") : "") ?>" href="../dashboard/students-admin.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="14px" height="14px" viewBox="0 0 29.254 29.254" style="enable-background:new 0 0 29.254 29.254;" xml:space="preserve">
              <g>
                <g>
      ...
      <li class="nav-item">
        <a class="nav-link  <?php echo (isset($option) ? (($option == 5) ? "active" : "") : "") ?>" href="/dashboard/menus-admin.php">
          ...
          <span class="nav-link-text ms-1 text-wrap">Administración de menús</span>
        </a>
      </li>
    <?php endif; ?>
